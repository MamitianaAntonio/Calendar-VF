...
import montre from '../../img/montre.jpg';
...
/*   const handleShowTotalHours = (email) => {
  ...
  return (
    <>
      <h1 className={styles.title}>Formulaire de cours</h1>
      ...
      <div className={styles.Ensemble}>
        ...
        <div className={styles.Cour}>
          ...
          <SelectProfessors
            onSelect={setSelectedProfessors}
            onRemove={handleRemoveProfessor}
            /* onShowTotalHours={handleShowTotalHours} */
          />
          ...
          <div className={styles['form-group']}>
            <label htmlFor="start">Début du cours</label>
            <input
              type="datetime-local"
              value={start}
          ...
          <div className={styles['form-group']}>
            <label htmlFor='end'>Fin du cours</label>
            <input
              type="datetime-local"
              value={end}
          ...
          <br/>
          {/* bouton d'ajout */}
          <button onClick={createCalendarEvent}>Créer le cours</button>
        </div>
        

        {/* montre */}
        <div className={styles.montre}>
           <img src={montre} alt="montre" width="200px" height="200px"/>
        </div>
      </div>
    </>
  );
